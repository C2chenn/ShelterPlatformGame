var bamboo1 = {
    ...
    preload: function() {
        ...
        game.load.tilemap('tilemap1', 'assets/bamboo1.json', null, Phaser.Tilemap.TILED_JSON);
    ...
    create: function() {
        ...
        while (start > 150) {
            var platform = this.platforms.create(300, start,'platform', this.platforms);
    ...
    update: function() {
        ...
        if (this.score >= 1){
            if (this.passed == false) {
                this.tablet = game.add.sprite(320, 42, 'tablet');
